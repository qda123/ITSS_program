      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <ul class="nav navbar-nav">
            ...
            <li><a href="viewVaccine.php">Xem danh sách vaccine</a></li>
            <li class="active"><a href="../../html/admin/quanlyVaccine/searchVaccine.html">Tìm kiếm vaccine</a></li>
            ...
            <form action="searchVaccine.php" method="post">
