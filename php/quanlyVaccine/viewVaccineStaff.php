      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="viewVaccineStaff.php">Xem danh sách vaccine</a></li>
            <li><a href="../../html/staff/quanLyVaccine/searchVaccine.html">Tìm kiếm vaccine</a></li>
                ...
                <?php
                    ...
                    while ($r = mysqli_fetch_assoc($result))
                    {
                        ...
                        <tr>
                            ...
                            <td><a href="editVaccineStaff.php?sid=<?php echo $r['idVaccine'] ?>" class="btn btn-info">Sửa</a>
                             <a onclick="return confirm('Bạn có muốn xóa vaccine này không?')" href="deleteVaccineStaff.php?sid=<?php echo $r['idVaccine'] ?>" class="btn btn-danger">Xóa</a></td>
                        </tr>
                        <?php
                    }
                ?>
