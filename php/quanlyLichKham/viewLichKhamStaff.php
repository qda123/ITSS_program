      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="viewLichKhamStaff.php">Xem danh sách lịch khám</a></li>
            <li><a href="../../html/staff/quanLyLichKham/searchLichKham.html">Tìm kiếm lịch khám</a></li>
          </ul>
        </div>
      </nav>
