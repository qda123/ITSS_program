      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <ul class="nav navbar-nav">
            ...
            <li><a href="viewLichKham.php">Xem danh sách lịch khám</a></li>
            <li class="active"><a href="../../html/admin/quanlyLichKham/searchLichKham.html">Tìm kiếm lịch khám</a></li>
            ...
            <form action="searchLichKham.php" method="post">
