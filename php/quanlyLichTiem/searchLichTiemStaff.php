      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <ul class="nav navbar-nav">
            ...
            <li><a href="viewLichTiemStaff.php">Xem danh sách lịch tiêm</a></li>
            <li class="active"><a href="../../html/staff/quanLyLichTiem/searchLichTiem.html">Tìm kiếm lịch tiêm</a></li>
          </ul>
        </div>
      </nav>
            ...
            <form action="searchLichTiemStaff.php" method="post">
