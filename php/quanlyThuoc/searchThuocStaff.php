      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <ul class="nav navbar-nav">
            ...
            <li><a href="viewThuocStaff.php">Xem danh sách thuốc</a></li>
            <li class="active"><a href="../../html/staff/quanLyThuoc/searchThuoc.html">Tìm kiếm thuốc</a></li>
            ...
            <form action="searchThuocStaff.php" method="post">
