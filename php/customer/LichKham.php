      ...
      <nav class="navbar navbar-default">
        ...
        <body>
          <div class="list-group">
            <a href="LichKham/viewLichKham.php?user=<?php echo $sdt?>" class="list-group-item">Xem danh sách các lịch khám</a>
            <a href="LichKham/searchLichKham.php?user=<?php echo $sdt?>" class="list-group-item">Tìm kiếm lịch khám</a>
            <a href="LichKham/viewCacLichKhamDaDangKy.php?user=<?php echo $sdt?>" class="list-group-item">Các lịch khám đã đăng ký</a>
          </div>
        </body>
