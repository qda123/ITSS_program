...
$view_sql="SELECT * FROM DKLichKham WHERE idNguoiBenh = $idNguoiBenh ";
...
<body>
      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="viewCacLichKhamDaDangKy.php?user=<?php echo $sdt?>">Các lịch khám đã đăng ký</a></li>
      ...
      <div class="container">
        ...
        <h1>Danh sách các lịch khám đã đăng ký</h1>       
            <table class="table table-striped">
                ...
                while ($r1 = mysqli_fetch_assoc($result1))
                {
                    ...
                    $idLichKham = $r1['idLichKham'];
                    $v="SELECT * FROM LichKham WHERE idLichKham = $idLichKham ";
                    ...
                    ?>
                        <tr>    
                        <td><?php echo $r2['noidungkham'] ?></td>
                        <td><?php echo $r2['ngaykham'] ?></td>
